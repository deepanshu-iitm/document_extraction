...
PREDICTIONS_ROOT = Path("outputs/predictions/paddle_baseline")
...
def main():
    ...
    for group in GROUPS:
        ...
        for image_path in tqdm(image_paths, desc=f"{group}"):
            ...
            prediction = extract_text_paddle(image_path)
    ...
    detailed_csv_path = METRICS_ROOT / "paddle_baseline_detailed_results.csv"
    ...
    group_summary_csv_path = METRICS_ROOT / "paddle_baseline_group_summary.csv"
    ...
    overall_summary_path = METRICS_ROOT / "paddle_baseline_overall_summary.txt"
