...
PREDICTIONS_ROOT = Path("outputs/predictions/hybrid_baseline")
...
def main():
    ...
    detailed_csv_path = METRICS_ROOT / "hybrid_baseline_detailed_results.csv"
    ...
    group_summary_csv_path = METRICS_ROOT / "hybrid_baseline_group_summary.csv"
    ...
    overall_summary_path = METRICS_ROOT / "hybrid_baseline_overall_summary.txt"
